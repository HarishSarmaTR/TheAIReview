...
def get_app_version():
    ...
    return config.get("app_version", "2.1.6")
...
def get_release_date():
    ...
    config = get_version_config()
    return config.get("release_date", "2025-08-26")

def get_version_info():
    """Get complete version information"""
    config = get_version_config()
    return {
        'version': config.get("app_version", "2.1.6"),
        'name': config.get("app_name", "AI Code Review Tool"),
        'release_date': config.get("release_date", "2025-08-26"),
