# Build Executable Script for AI Review Tool v2.0.2
...
Write-Host "AI Review Tool v2.0.2 Builder" -ForegroundColor Cyan
...
# Use the specific spec file for version 2.0.2
$specFile = "AIReviewTool_V2.0.2.spec"
...
Try {
    ...
    Write-Host "Version: 2.0.2" -ForegroundColor Cyan
