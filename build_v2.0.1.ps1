# Build Executable Script for AI Review Tool v2.0.1
...
Write-Host "AI Review Tool v2.0.1 Builder" -ForegroundColor Cyan
...
# Use the specific spec file for version 2.0.1
$specFile = "AIReviewTool_V2.0.1.spec"
